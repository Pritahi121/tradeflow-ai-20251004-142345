...
-- Create user_credits if not exists
...
-- Create purchase_orders if not exists
...
-- Create user_integrations if not exists
...
-- Create credit_transactions if not exists
...
DROP TRIGGER IF EXISTS on_po_completed ON public.purchase_orders;
